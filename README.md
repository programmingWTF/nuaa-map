...
- **智能问答助手**：新生可通过自然语言提问，获取校园相关信息（由④组 QA 知识库驱动）
...
| ④ 调研与数据收集 | 李睿、蒋荀莉、张聿修、王小雯 | 采集校园 QA 问答知识库（核心）、建筑信息（次要） |
...
| [QA 知识库模板](docs/templates/qa-knowledge.json) | ④组核心产出：问答数据模板 |
| [建筑信息模板](docs/templates/building-info.json) | ④组次要产出：建筑信息模板 |
