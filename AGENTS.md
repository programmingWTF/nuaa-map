...
"帮我检查 data/qa/ 下的所有问答数据，找出答案不准确或格式不符合模板的地方。"
```

### ⑤ 智能体训练组

```
"基于 LangChain 搭建 RAG 管道，以 data/qa/ 为核心知识库，data/positions/ 为辅助，
...
- ④组核心产出是 QA 问答知识库（data/qa/），直接供大模型检索
